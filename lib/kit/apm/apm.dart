...
class ApmKitName {
  static const String KIT_FPS = 'fps';
  static const String KIT_MEMORY = 'memory';
  static const String KIT_LOG = 'log cat';
  static const String KIT_ROUTE = 'router info';
  static const String KIT_CHANNEL = 'method channel';
  static const String KIT_HTTP = 'http request';
  static const String KIT_SOURCE_CODE = 'source code';
  static const String KIT_PAGE_LAUNCH = 'time on startup';
}
