            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                    ...
                    child: Text('only system Channel',
                        style: TextStyle(
  ...
  String getChannelType() {
    switch (widget.item.type) {
      case ChannelInfo.TYPE_USER_SEND:
        return 'Flutter > terminal';
      case ChannelInfo.TYPE_USER_RECEIVE:
        return 'terminal > Flutter';
      case ChannelInfo.TYPE_SYSTEM_SEND:
        return 'Flutter > terminal [invoked by system]';
      case ChannelInfo.TYPE_SYSTEM_RECEIVE:
        return 'terminal > Flutter [invoked by system]';
      default:
        return 'Flutter > terminal';
    }
  }
