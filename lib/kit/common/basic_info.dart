...
class BasicInfoPage extends StatelessWidget {
  ...
  List<Widget> buildAppInfo() {
    ...
    list.add(Container(
        ...
        child: Text(
            'VM info ' +
                (!kReleaseMode ? '' : '[not available in release mode]'),
            style: TextStyle(fontSize: 14, color: Color(0xff999999)))));
    list.add(InfoItem('CPU', VmHelper.instance.vm?.hostCPU));
    list.add(Divider(height: 0.5, color: Color(0xffeeeeee)));
    list.add(InfoItem('Dart VM', VmHelper.instance.vm?.version));
    list.add(Divider(height: 0.5, color: Color(0xffeeeeee)));
    list.add(InfoItem('Flutter Version', VmHelper.instance.flutterVersion));
    list.add(Divider(height: 0.5, color: Color(0xffeeeeee)));
    ...
    list.add(Container(
        ...
        child: Text('Package info',
            style: TextStyle(fontSize: 14, color: Color(0xff999999)))));
    list.add(InfoItem(
        'App package name', VmHelper.instance.packageInfo?.packageName));
    list.add(Divider(height: 0.5, color: Color(0xffeeeeee)));
    list.add(InfoItem(
        'Module Version',
